...
Read [Adding dependencies to a Swift package](../AddingDependencies.md) for more information on adding dependencies, and [Resolving and updating dependencies](../ResolvingPackageVersions.md) for how the package manager resolves and records dependencies.
