...
There are two ways to put a package in editable state, using [swift package edit](../Package/PackageEdit.md).
...
You can end editing a package with [swift package unedit](../Package/PackageUnedit.md).
...
Use [swift package unedit](../Package/PackageUnedit.md) command to stop using the local checkout:
