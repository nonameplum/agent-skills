...
Prior to running a build or test, or when you run [swift package resolve](../Package/PackageResolve.md), the package manager walks through the dependencies in your package, and all their dependencies recursively, to build a complete list.
...
You can view these dependencies using the command [swift package show-dependencies](../Package/PackageShowDependencies.md), which provides a succint list of the entire set of dependencies.
