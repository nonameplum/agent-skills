...
SEE ALSO: [swift run](../SwiftRun.md), [swift package](../SwiftPackageCommands.md), [swift test](../SwiftTest.md)
...
- ****--print-pif-manifest-graph****: *Write the PIF JSON sent to Swift Build as a Graphviz file.*
...
- ****--static-swift-stdlib|no-static-swift-stdlib****: *Link Swift stdlib statically.*
