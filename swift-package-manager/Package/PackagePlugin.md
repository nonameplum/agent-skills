...
- ****--allow-writing-to-directory=\<allow-writing-to-directory\>****: *Allow the plugin to write to an additional directory.*

- ****--allow-network-connections=\<allow-network-connections\>****: - term **--package=\<package\>**:

*Limit available plugins to a single package with the given identity.*

- ****command****: *Verb of the command plugin to invoke.*

- ****arguments****: *Arguments to pass to the command plugin.*
