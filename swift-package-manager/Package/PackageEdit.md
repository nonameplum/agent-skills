...
- ****--revision=\<revision\>****: *The revision to edit.*

- ****--branch=\<branch\>****: *The branch to create.*

- ****--path=\<path\>****: *Create or use the checkout at this path.*

- ****package-identity****: *The identity of the package to edit.*
