...
- ****--minimum-access-level=\<minimum-access-level\>****: *Include symbols with this access level or more. Possible values: private | fileprivate | internal | package | public | open.*
...
- ****--emit-extension-block-symbols|omit-extension-block-symbols****: *Emit extension block symbols for extensions to external types or directly associate members and conformances with the extended nominal.*
