...
- ****--format=\<format\>****: *Set the output format. Available formats: flatlist (default), json*

- ****--package-id=\<packageId\>****: *Select a package to display the traits. Default is the current root package.*
