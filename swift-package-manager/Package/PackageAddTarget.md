...
- ****--type=\<type\>****: *The type of target to add.*

- ****--dependencies=\<dependencies\>****: *A list of target dependency names.*
...
- ****--testing-library=\<testing-library\>****: *The testing library to use when generating test targets, which can be one of 'xctest', 'swift-testing', or 'none'.*
