...
- ****--targets=\<targets\>****: *The targets to migrate to specified set of features.*

- ****--to-feature=\<to-feature\>****: *The Swift language upcoming/experimental feature to migrate to.*
