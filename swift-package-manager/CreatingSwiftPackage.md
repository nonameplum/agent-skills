...
Swift package manager supports creating packages using [swift package init](../Package/PackageInit.md).
...
You can immediately use both of [swift build](../SwiftBuild.md) and [swift test](../SwiftTest.md):
...
Use `tool` for the `type` option in [swift package init](../Package/PackageInit.md).
