...
- ****bundle-path-or-url****: *A local filesystem path or a URL of a Swift SDK bundle to install.*

- ****--checksum=\<checksum\>****: *The checksum of the bundle generated with `swift package compute-checksum`.*
