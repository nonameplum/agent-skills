...
Write package plugins using the `PackagePlugin` API provided by the Swift Package Manager. 
...
- **Build Plugin**: Custom build tool tasks that provide commands to run before or during the build.
  See [Enable a build plugin](../Plugins/EnableBuildPlugin.md) to see how to add an existing build plugin, or [Writing a build tool plugin](../Plugins/WritingBuildToolPlugin.md) to write your own.

- **Command Plugin**: Custom commands that you run using the `swift package` command line interface.
  See [Enable a command plugin](../Plugins/EnableCommandPlugin.md) to see how to add an existing command plugin, or [Writing a command plugin](../Plugins/WritingCommandPlugin.md) to write your own.
...
- [Enable a command plugin](../Plugins/EnableCommandPlugin.md)
- [Enable a build plugin](../Plugins/EnableBuildPlugin.md)

### Writing Plugins

- [Writing a command plugin](../Plugins/WritingCommandPlugin.md)
- [Writing a build tool plugin](../Plugins/WritingBuildToolPlugin.md)
