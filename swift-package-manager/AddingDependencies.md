...
The package manager automatically resolves packages when you invoke [swift run](../SwiftRun.md) or [swift build](../SwiftBuild.md). 
You can explicitly resolve the packages with the command [swift package resolve](../Package/PackageResolve.md).
For more information on resolving package versions, see [Resolving and updating dependencies](../ResolvingPackageVersions.md).
...
To determine what traits a package offers, including its defaults, either inspect its `Package.swift` manifest or use [swift package show-dependencies](../Package/PackageShowDependencies.md) to print out the resolved dependencies and their traits.
...
To learn how to provide packages with traits, see [Provide configurable packages using traits.](../Dependencies/PackageTraits.md).
...
For more information on using a library provided by the system as a dependency, see [Adding a dependency on a system library.](../Dependencies/AddingSystemLibraryDependency.md).
...
- [Resolving and updating dependencies](../ResolvingPackageVersions.md)
- [Provide configurable packages using traits.](../Dependencies/PackageTraits.md)
- [Resolving package dependency failures](../Dependencies/ResolvingDependencyFailures.md)
- [Adding a dependency on a system library.](../Dependencies/AddingSystemLibraryDependency.md)
- [Swift package example that uses system library dependency with pkg-config](../Dependencies/ExampleSystemLibraryPkgConfig.md)
- [Editing a remote dependency used in a Swift package](../Dependencies/EditingDependencyPackage.md)
