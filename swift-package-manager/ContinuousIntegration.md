...
Run [swift package update](../Package/PackageUpdate.md) to update dependencies to the latest eligible versions and update `Package.resolved`.
For more information on resolving and updating dependencies, see [Resolving and updating dependencies](../ResolvingPackageVersions.md).
